...
type ComplexMessage struct {
	...
	MyMessage *DummyMessage   `protobuf:"bytes,2,opt,name=myMessage,proto3" json:"myMessage,omitempty"`
	MyHist    []*DummyMessage `protobuf:"bytes,3,rep,name=myHist,proto3" json:"myHist,omitempty"`
}
...
func (x *ComplexMessage) GetMyMessage() *DummyMessage {
	if x != nil {
		return x.MyMessage
	}
	return nil
...
func (x *ComplexMessage) GetMyHist() []*DummyMessage {
	if x != nil {
		return x.MyHist
	}
	return nil
...
func (x *DummyMessage) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *DummyMessage) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
var file_complex_complex_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x42, 0x0b, 0x5a, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x70, 0x62, 0x62, 0x06,
...
var file_complex_complex_proto_depIdxs = []int32{
	1, // 0: ComplexMessage.myMessage:type_name -> DummyMessage
	1, // 1: ComplexMessage.myHist:type_name -> DummyMessage
